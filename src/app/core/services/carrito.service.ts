...
export class CarritoService {
  ...
  modificarCantidadProducto(idProducto:number, cantidadCambiar:number){
    const index = this.carrito
  }
  ...
  calcularTotal(){
    ...
    this.carrito.forEach(item =>{
      this.totalCarrito = this.totalCarrito + item.producto.precio + item.producto.precio * item.cantidad;
    })
